...
public:
	...
	/// </summary>
	__AEModuleBase(void) noexcept : m_ullModuleId(__AEModuleBase<T>::m_ullInstanceCounter.fetch_add(1, std::memory_order::relaxed)) {
		__AEModuleBase<T>::m_ullModulesAlive.fetch_add(1, std::memory_order::relaxed);
	}
	...
	__AEModuleBase(const __AEModuleBase<T>& val) noexcept : 
		m_ullModuleId(__AEModuleBase<T>::m_ullInstanceCounter.fetch_add(1, std::memory_order::relaxed)) {
		__AEModuleBase<T>::m_ullModulesAlive.fetch_add(1, std::memory_order::relaxed);
	}
	...
	virtual ~__AEModuleBase(void) noexcept {
		this->m_ullModulesAlive.fetch_sub(1, std::memory_order::relaxed);
	}
	...
	[[nodiscard]] static inline ullint getModuleAmount(void) noexcept {
		return __AEModuleBase<T>::m_ullModulesAlive.load(std::memory_order::relaxed);
	}
	...
	[[nodiscard]] static constexpr const ullint getInstanceCounter(void) noexcept {
		return __AEModuleBase<T>::m_ullInstanceCounter.load(std::memory_order::relaxed);
	}
